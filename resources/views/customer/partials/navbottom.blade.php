...
<div class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 shadow-lg z-40">
    <div class="flex justify-around items-center py-2">
        ...
        @if(Auth::guard('customer')->check())
            ...
            <a href="{{ route('cart.index') }}" class="flex flex-col items-center py-1 px-3 {{ $cartActive }} relative">
            ...
            <a href="{{ route('profile.account') }}" class="flex flex-col items-center py-1 px-3 {{ $profileActive }}">
