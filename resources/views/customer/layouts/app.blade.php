        ...
        <div class="container">
            <div class="row gy-8">
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div>
                                <h4 class="fs-5 mb-4">Help Center</h4>
                                <ul class="list-unstyled lh-lg small">
            ...
            <div class="border-top mt-8 pt-6 row small">
                <div class="col-12 d-flex flex-column flex-md-row justify-content-between">
                    <div>
                        <p>© 2026 LearnHub. All rights reserved. Develop by <a href="https://codescandy.com/"
                                class="link-primary" target="_blank">Codescandy</a></p>
                    </div>
                    <div>
                        <div class="">
                            ...
                            <a href="#" class="btn rounded-circle btn-light btn-icon btn-xs">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="icon icon-tabler icons-tabler-brand-github ">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path
