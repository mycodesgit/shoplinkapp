...
<body class="template-index home2-default">
    ...
    <div class="pageWrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-10 col-sm-8 col-md-5 col-lg-4">
                        ...
                        <p class="phone-no text-light"><i class="anm anm-phone-s"></i> +440 0(111) 044 833</p>
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4 d-none d-lg-none d-md-block d-lg-block">
                        <div class="text-center">
                            <p class="top-header_middle-text text-light"> Express Shipping</p>
                        </div>
                    </div>
                    <div class="col-2 col-sm-4 col-md-3 col-lg-4 text-right">
                        ...
                        <ul class="customer-links list-inline">
                            ...
                            <li><a class="text-light" href="register.html">Create Account</a></li>
                            <li><a class="text-light" href="wishlist.html">Wishlist</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!--Header-->
        <div class="header-wrap animated d-flex border-bottom-0" style="background-color: #9b9eac">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <!--Desktop Logo-->
                    <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                        <a href="index.html">
                            <img src="assets/images/logosl.png" alt="ShopLink Logo" title="ShopLink Logo" width="141px" height="46px" />
                        </a>
                    </div>
                    <!--End Desktop Logo-->
                        ...
                        <nav class="grid__item" id="AccessibleNav">
                            ...
                            <ul id="siteNav" class="site-nav medium center hidearrow">
                                <li class="lvl1 parent megamenu">
                                    <a href="#" style="color: #FFF">Home <i class="anm anm-angle-down-l"></i></a>
                                </li>
                                <li class="lvl1 parent megamenu">
                                    <a href="#" style="color: #FFF">Categories <i class="anm anm-angle-down-l"></i></a>
                                </li>
                                <li class="lvl1 parent megamenu">
                                    <a href="#" style="color: #FFF">Products <i class="anm anm-angle-down-l"></i></a>
                                </li>
                                <li class="lvl1 parent megamenu">
                                    <a href="#" style="color: #FFF">About <i class="anm anm-angle-down-l"></i></a>
                                </li>
                                <li class="lvl1"><a href="#" style="color: #ff0000;"><b>Buy Now!</b> <i class="anm anm-angle-down-l"></i></a>
                                </li>
                            </ul>
                        </nav>
                        <!--End Desktop Menu-->
                    ...
                    <div class="slide">
                        <div class="blur-up lazyload">
                            <img class="blur-up lazyload"
                                data-src="assets/images/slideshow-banners/home2-default-banner2.jpg"
                                src="assets/images/slideshow-banners/home2-default-banner2.jpg"
                            ...
                            <div class="productSlider grid-products">
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.html" class="grid-view-item__link">
                                            ...
                                            <!-- Variant Image-->
                                            <!-- product label -->
                                            <div class="product-labels rounded"><span class="lbl on-sale">Sale</span>
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <!-- Color Variant -->
                                        <ul class="swatches">
                                            <li class="swatch small rounded navy"
                                                rel="assets/images/product-images/product-image-stw1.jpg"></li>
                                            <li class="swatch small rounded green"
                                                rel="assets/images/product-images/product-image-stw1-1.jpg"></li>
                                            <li class="swatch small rounded gray"
                                                rel="assets/images/product-images/product-image-stw1-2.jpg"></li>
                                            <li class="swatch small rounded aqua"
                                                rel="assets/images/product-images/product-image-stw1-3.jpg"></li>
                                            <li class="swatch small rounded orange"
                                                rel="assets/images/product-images/product-image-stw1-4.jpg"></li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                    <!-- End product details -->
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <!-- Color Variant -->
                                        <ul class="swatches">
                                            <li class="swatch small rounded black"
                                                rel="assets/images/product-images/product-image2.jpg"></li>
                                            <li class="swatch small rounded navy"
                                                rel="assets/images/product-images/product-image-swt2.jpg"></li>
                                            <li class="swatch small rounded purple"
                                                rel="assets/images/product-images/product-image-swt2-1.jpg"></li>
                                            <li class="swatch small rounded teal"
                                                rel="assets/images/product-images/product-image-swt2-2.jpg"></li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                    <!-- End product details -->
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.html" class="grid-view-item__link">
                                            ...
                                            <!-- Variant Image-->
                                            <!-- product label -->
                                            <div class="product-labels rounded"><span class="lbl pr-label2">Hot</span>
                                            </div>
                                            <!-- End product label -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <ul class="swatches">
                                            <li class="swatch small rounded gray"
                                                rel="assets/images/product-images/product-image16.jpg"></li>
                                            <li class="swatch small rounded red"
                                                rel="assets/images/product-images/product-image5.jpg"></li>
                                            <li class="swatch small rounded orange"
                                                rel="assets/images/product-images/product-image5-1.jpg"></li>
                                            <li class="swatch small rounded yellow"
                                                rel="assets/images/product-images/product-image17.jpg"></li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                    <!-- End product details -->
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <ul class="swatches">
                                            <li class="swatch small rounded black"
                                                rel="assets/images/product-images/cape-dress-2.jpg"></li>
                                            <li class="swatch small rounded maroon"
                                                rel="assets/images/product-images/product-image4-1.jpg"></li>
                                            <li class="swatch small rounded navy"
                                                rel="assets/images/product-images/product-image2.jpg"></li>
                                            <li class="swatch small rounded darkgreen"
                                                rel="assets/images/product-images/product-image2-1.jpg"></li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                    <!-- End product details -->
                            ...
                            <div class="col-6 col-sm-2 col-md-3 col-lg-3 item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout-1.html" class="grid-view-item__link">
                                        ...
                                        <!-- Variant Image-->
                                        <!-- product label -->
                                        <div class="product-labels rounded"><span class="lbl on-sale">Sale</span> <span
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout-1.html" class="grid-view-item__link">
                                        ...
                                        <img class="primary blur-up lazyload"
                                            ...
                                            src="assets/images/product-images/product-image19.jpg" alt="image"
                                            title="product" />
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload"
                                            data-src="assets/images/product-images/product-image19-1.jpg"
                                            src="assets/images/product-images/product-image19-1.jpg" alt="image"
                                            title="product" />
                                        <!-- End hover image -->
                                    </a>
                                    <!-- end product image -->
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout-1.html" class="grid-view-item__link">
                                        ...
                                        <img class="primary blur-up lazyload"
                                            ...
                                            src="assets/images/product-images/product-image18.jpg" alt="image"
                                            title="product" />
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload"
                                            data-src="assets/images/product-images/product-image18-1.jpg"
                                            src="assets/images/product-images/product-image18-1.jpg" alt="image"
                                            title="product" />
                                        <!-- End hover image -->
                                    </a>
                                    <!-- end product image -->
        ...
        <footer id="footer" class="footer-2">
            <div class="newsletter-section border-bottom-0 border-right-0 border-left-0" style="background-color: #9a9dac;">
                <div class="container">
                    <div class="row">
            ...
            <div class="site-footer" style="background-color: #74788a;">
                <div class="container">
                    <!--Footer Links-->
